...
//            TFile *myOutFile = new TFile("EfficienciesAndSF_"+nomDirectory+".root","RECREATE");
            TFile *myOutFile = new TFile("cnt_EfficienciesAndSF_"+nomDirectory+".root","RECREATE");
...
//            TDirectory *plotFinalDirectory = efficienciesDATA->GetDirectory("tpTree/"+nomDirectory+"/fit_eff_plots");
            TDirectory *plotFinalDirectory = efficienciesDATA->GetDirectory("tpTree/"+nomDirectory+"/cnt_eff_plots");
...
//            TDirectory *plotFinalDirectoryMC = efficienciesMC->GetDirectory("tpTree/"+nomDirectory+"/fit_eff_plots");
            TDirectory *plotFinalDirectoryMC = efficienciesMC->GetDirectory("tpTree/"+nomDirectory+"/cnt_eff_plots");
...
//                TCanvas *theCanvas = (TCanvas*) efficienciesDATA->Get("tpTree/"+nomDirectory+"/fit_eff_plots/"+nomContent);
                TCanvas *theCanvas = (TCanvas*) efficienciesDATA->Get("tpTree/"+nomDirectory+"/cnt_eff_plots/"+nomContent);
...
//                TCanvas *theCanvasMC = (TCanvas*) efficienciesMC->Get("tpTree/"+nomDirectory+"/fit_eff_plots/"+nomContent);
                TCanvas *theCanvasMC = (TCanvas*) efficienciesMC->Get("tpTree/"+nomDirectory+"/cnt_eff_plots/"+nomContent);
...
//                            TCanvas *theCanvas1D = (TCanvas*) efficienciesDATA->Get("tpTree/"+nomDirectory+"/fit_eff_plots/"+name1D);
                            TCanvas *theCanvas1D = (TCanvas*) efficienciesDATA->Get("tpTree/"+nomDirectory+"/cnt_eff_plots/"+name1D);
...
//                            TCanvas *theCanvas1Dmc = (TCanvas*) efficienciesMC->Get("tpTree/"+nomDirectory+"/fit_eff_plots/"+name1Dmc);
                            TCanvas *theCanvas1Dmc = (TCanvas*) efficienciesMC->Get("tpTree/"+nomDirectory+"/cnt_eff_plots/"+name1Dmc);
                        ...
                        dataPlots->cd();
                        histo2D->SetMaximum(1.00);
                        histo2D->SetMinimum(0.85);
                        histo2D->Write(shortNamePlot+"_DATA");
                        mcPlots->cd();
                        histo2DMC->SetMaximum(1.00);
                        histo2DMC->SetMinimum(0.85);
...
//                        histo2Dratio->Divide(histo2D,histo2DMC,1,1);
                        histo2Dratio->Divide(histo2DMC);
                        histo2Dratio->SetMaximum(1.02);
                        histo2Dratio->SetMinimum(0.98);
                        histo2Dratio->Write();
                    }
                }
            }
