...
void extractPlotsAndComputeTheSFs(TString era, TString theIDname, TString dataFile, TString mcFile){
    ...
    while ((keyDATA = (TKey*)listPlotsDATA())) {
        ...
        if (typeDirectory== "TDirectoryFile"){
            ...
            TFile *myOutFile = new TFile("EfficienciesAndSF_Run"+era+"_"+nomDirectory+".root","RECREATE");
